package 
{
	...
	public class BaseTooltip extends Sprite
	{
		...
		public function remove():void {
			if(FBPanel.tooltipSprite.contains(this))
				FBPanel.tooltipSprite.removeChild(this);
		...
		private function onTimerFired(event:TimerEvent):void {
			FBPanel.tooltipSprite.addChild(this);
			//visible = true;
		...
		private function onMouseMove(event:MouseEvent):void {
			...
			if(!FBPanel.tooltipSprite.contains(this)) return;
			//if(!visible) return;
