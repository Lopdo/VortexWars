package MapEditor
{
	...
	public class MapEditorAdmin extends Sprite
	{
		...
		public function MapEditorAdmin()
		{
			super();
			...
			G.client.bigDB.loadRange("CustomMaps", "status", [1], null, null, 9, function(maps:Array):void {
				createMapList(maps);
		...
		protected function submisionMapCell(map:DatabaseObject, index:int, yOffset:int):void {
			...
			/*button = new ButtonHex("PREVIEW", function():void { new MapEditorPreviewCreator(map.key);}, "button_small_gray");
			button.x = 160;
			button.y = 56;
			cellBg.addChild(button);*/
		}
		...
		protected function onEditMapClicked(mapKey:String):void {
			parent.addChild(new MapEditorScreen(mapKey, true));
